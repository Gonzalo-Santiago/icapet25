      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Select value={filters.campo} onValueChange={(value) => onFilterChange("campo", value)}>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Select value={filters.especialidad} onValueChange={(value) => onFilterChange("especialidad", value)} disabled={!especialidades.length}>
        ...
        <div className="space-y-2">
          <Label htmlFor="curso">Curso</Label>
           <div className="relative">
            ...
            <Select value={filters.curso} onValueChange={(value) => onFilterChange("curso", value)} disabled={!cursos.length}>
